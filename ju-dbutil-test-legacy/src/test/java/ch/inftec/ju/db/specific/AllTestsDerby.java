...
import ch.inftec.ju.db.auth.AuthenticationEditorModelTest;
...
@SuiteClasses({ BasicDbTest.class, JpaTest.class, JuDbUtilsTest.class, MultiplePersistenceUnitsTest.class,
	AuthenticationEditorModelTest.class, AuthenticationTest.class, DbActionTest.class, DbChangeSetTest.class})
