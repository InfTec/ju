...
//			
//			
//			// Rather dirty workaround as Hibernate doesn't expose the
//			// SchemaExport interface very conveniently to have it re-create a Schema
//			// programmatically
//			ConnectionInfo ci = this.contextHolder.getConnectionInfo();
//			String connectionName = ci != null ? ci.getName() : null;
//			if ("TeamPlayer DB2".equals(connectionName)
//					&& !tableForSecondUnitCreated) {
//				this.entityManager.createNativeQuery("create table Team (id bigint generated by default as identity, foundingDate date, name varchar(255), ranking integer not null, version integer not null, primary key (id))").executeUpdate();
//				this.tableForSecondUnitCreated = true;
//			}
		}
...
//		private JuDbUtils juDbUtils;
	...
	public void multiplePersistenceUnits() {
		...
		entityManagerTest.createDb(); // XXX Creating table explicitly...
