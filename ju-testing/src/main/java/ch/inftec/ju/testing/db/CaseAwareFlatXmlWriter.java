...
/**
 * Custom implementation of the FlatXmlWriter class. The original class cannot be
 * extended easily, so I just copied the whole source.
 * <p>
 * This class provides repeatable casing for column names. The original class had
 * lower or mixed case column names for MySQL and upper case for most other DBs.
 * <p>
 * Changes made to the original code are commented with // JU: ...
 * 
 ...
 */
public class CaseAwareFlatXmlWriter implements IDataSetConsumer
{
    /**
     * Logger for this class
     */
    private static final Logger logger = LoggerFactory.getLogger(CaseAwareFlatXmlWriter.class);
    ...
    public CaseAwareFlatXmlWriter(OutputStream out) throws IOException
    {
        this(out, null);
    }
